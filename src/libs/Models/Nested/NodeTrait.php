<?php
namespace Cesi\Core\libs\Models\Nested;
...
//        $this->original = array_merge($this->original, $attributes);
     ...
     *
     * @return \Cesi\Core\Libs\Models\Nested\QueryBuilder
     */
    ...
    {
        return $this->getAttributeValue($this->getLevelName());
    }
    ...
    {
        $this->attributes[$this->getLevelName()] = $value;
