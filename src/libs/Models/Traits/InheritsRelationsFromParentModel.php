...
/**
 * This trait helps a child model (ex: CesiUser) inherit all relationships of its parent model (ex: User).
 * Laravel by default doesn't do that, so packages like Cesi\PermissionManager can't see relationships
 * on the CesiUser model, because they haven't been inherited from User.
 *
