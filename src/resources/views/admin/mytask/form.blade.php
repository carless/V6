                ...
                <div class="card-body form-horizontal">
                    <div class="form-group row {{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                            {{ Form::text('name', old('name', $entry->name), ['class' => 'form-control', 'placeholder' => '', 'readonly']) }}
                            @if ($errors->has('name'))
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group row {{ $errors->has('fecha_inicio') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <div class="input-group" style="width: 150px;">
                                        {{ Form::text('fecha_inicio', $fecha_inicio, ['class' => 'form-control', 'placeholder' => '', 'readonly']) }}
                            ...
                            <div class="form-group row {{ $errors->has('fecha_final') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <div class="input-group" style="width: 150px;">
                                        {{ Form::text('fecha_final', $fecha_final, ['class' => 'form-control', 'placeholder' => '', 'readonly']) }}
                                        <div class="input-group-append">
                                            <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                                        </div>
                                    </div>
